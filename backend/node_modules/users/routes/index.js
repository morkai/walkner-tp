...
try { multer = require('multer'); } catch (err) {}
...
const preparePicture = require('./preparePicture');

module.exports = (app, module) =>
{
  /* eslint-disable curly */
  if (!multer) module.debug('Unused dependency: multer');
  /* eslint-enable no-empty */
  ...
  express.post(
    ...
    checkLogin,
    hashPassword,
    preparePicture.bind(null, app, module),
  ...
  express.get('/users/:id.jpg', canBrowse, redirectToRemoteApi, pictureRoute.bind(null, app, module));
  ...
  express.get('/loginIn/:app', loginInRoute.bind(null, app, module));
